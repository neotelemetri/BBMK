...
}).call(this);﻿bbmk.controllerUKM = function () {
    _this = this;
    this.ukm_list = [];
...
};﻿bbmk.ukm = function (obj) {
    this.ukm_id = obj.ukm_id;
    this.ukm_name = obj.ukm_id;
    this.ukm_desc = obj.ukm_id;
    this.ukm_status = obj.ukm_status;
};﻿bbmk.user = function (obj, ukm_id) {
...
bbmk.ui.bind = function () {
...
}﻿;bbmk.util.ajaxCall = function () {

    this.getUKMList = function (callback) {       
        var url = bbmk.config.GET_UKM_LIST;
        $.ajax(url, {
            type: "GET",
            dataType: "json"
    ...
    this.getUKMMemberList = function (ukm_id, callback) {
        var url = bbmk.config.GET_UKM_MEMBER_LIST + "?ukm_id=" + ukm_id;
        $.ajax(url, {
            type: "GET",
            dataType: "json"
        }).done(function (data, textStatus, jqXHR) {
    ...
    this.getUKMBBBMKParticipantList = function (ukm_id, callback) {
        var url = bbmk.config.GET_UKM_BBMK_PARTICIPANT_LIST + "?ukm_id=" + ukm_id + "&" + param + "=" + value;
        console.log(url);
        $.ajax(url, {
            type: "GET",
            dataType: "json"
